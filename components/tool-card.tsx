...
export default function ToolCard() {
  ...
  return (
    <div className=" flex items-center justify-center cursor-pointer gap-2 hover:bg-muted rounded-xl p-4 w-[22rem]">
      <div className=" flex items-center gap-2">
        <div className=" bg-[#3c5870] p-2 rounded-md">
          <FaImage className=" size-8 text-background" />
        </div>
        <div className=" w-[12rem]">
          ...
          <p className=" text-sm leading-4 text-[#a5a5a5] ">
